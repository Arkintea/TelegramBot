...
async def welcome(message: types.Message):
    ...
    """
    await message.reply("Hi\nI am a Chat Bot! Created by Arkintea. How can i assist you?")


#Function to present help mode
...
async def helper(message: types.Message):
    ...
    """
    help_command = """
    Hi There, I'm a bot created by Arkintea! Please follow these commands - 
